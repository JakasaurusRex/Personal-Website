...
<Feature title="VISER - Columbia Graphics and User Interfaces Researcher" location="New York, NY" desc="I will be developing a UI and UX for Columbia Graphics and User Interfaces Lab's VISER VR application in Unity. The VISER application allows for glaciologist to view radar scanned glaciers in a 3D VR environment. I will be helping redesign the UI and graphics to be more intuitive for users." time="September 2023 - Present" imgUrl="/CSColumbia.png" webLink="https://graphics.cs.columbia.edu/home" />
...
<Feature title="Advanced Programming Teacher Assistant - CS@Columbia University" location="New York, NY" desc="Graded labs and assessments, hosted office hours, and aided in instruction of the class of 400 students. Addtionally hosted review sessions, worked to help update the grading infrastructure, and updated the course website." time="September 2022 - Present" imgUrl="/CSColumbia.png" webLink="https://www.cs.columbia.edu/"/>				
