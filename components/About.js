	...
	return (
		<section id="about"><Flex minWidth="full" backgroundColor="#faf8f7">
			...
			<Box> 
				...
				<Heading size="sm" fontWeight={500} px={12} justify="center"> I am currently a sophmore at <Link href="https://www.columbia.edu" color="gray">Columbia University</Link> in New York city studying Computer Science concentrating in Software Systems with an interest in Astronomy and Physics. Some of my interests outside of CS and physics are board games and video games (I am currently playing The Legend of Zelda: Tears of the Kingdom and Sackboy a Big Adventure) with friends, building computers and keyboards, video and photo editing, traveling (I am currently studying abroad in Madrid, Spain!), walking through nature, working out, EATING (I love food, especially ramen, fried rice, and cake), reading comics/manga (reading Vagabond right now!), and hanging out with my dogs Clifford and Homer. An interest I found more recently is creative writing for <Link href="https://www.bwog.com/author/jaket/" color="gray">Bwog</Link>, one of Columbia's student news organizations, which has been super fun! Another passion and hobby of mine is video game developing and modding which is what I work on in my free-time occasionally.  					
				</Heading> 	
			</Box>  
		</Flex></section>
	)
